...
stack_search_loop_##x:                                                     ; \
   leal GLOBL(_dzirq_stack)(, %ecx, 4), %ebx                               ; \
   cmpl $0, (%ebx)                                                         ; \
...
found_stack_##x:                                                           ; \
   ...
   cld                                    /* clear the direction flag */   ; \
									   ; \
   movl GLOBL(_dzirq_handler) + IRQ_HANDLER + IRQ_SIZE*x, %eax             ; \
   ...
   popw %es                                                                ; \
   popw %ds                                                                ; \
   ljmp *%cs:GLOBL(_dzirq_handler) + IRQ_OLDVEC + IRQ_SIZE*x               ; \
									   ; \
get_out_##x:                                                               ; \
   popal                                  /* iret */                       ; \
   popw %gs                                                                ; \
