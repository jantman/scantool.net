...
typedef enum {  _50,    _75,    _110,    _134,    _150,    _200,
               _300,   _600,   _1200,   _1800,   _2400,   _4800,
...
/* Comm port. */
typedef struct
{ /* General and communication parametrs
...
DZ_FUNC(void, comm_port_delete,        (comm_port *port));
DZ_FUNC(int,  comm_port_string_send,   (comm_port *port,char *s));
